...
((jQuery.fn.wowSlider = function (t) {
  ...
  function l() {
    (q.find(".ws_effect").fadeOut(200),
      e(ee).fadeIn(200).find("img").css({ visibility: "visible" }));
  }
    ...
    (e[0] || (e = z(e)),
      e.on((n ? "mousedown " : "") + "touchstart", function (e) {
        ...
        (t.gestures && q.addClass("ws_grabbing"),
          (d = 0),
          n
            ? ((r = n.pageX), (l = n.pageY), (f = p = 1), a && (f = p = a(e)))
            : (f = p = 0),
  ...
  function d(t) {
    ...
    return (
      e &&
        ...
        e
          ? "3d" == e[1]
            ? ((n.left = parseFloat(e[2]) || 0),
              (n.top = parseFloat(e[3]) || 0))
            : ((n.left = parseFloat(e[4]) || 0),
              (n.top = parseFloat(e[5]) || 0))
          : ((n.left = 0), (n.top = 0))),
      n
    );
  }
  ...
  function y() {
    function e(t) {
      ...
      var e = {
          ...
          "margin-bottom":
            -f.get(t).offsetTop + f.get(f.length - 1).offsetTop + "px",
        },
        n = p.get(t),
        i = {
      ...
      (0 > v
        ? (h.css(e), m.css(i))
        : (document.all || (e.opacity = 1),
          h.stop().animate(e, "fast"),
          m.stop().animate(i, "fast")),
        (v = t));
    }
    if (
      (q.find(".ws_bullets a,.ws_thumbs a").click(function (t) {
        w(t, z(this).index());
      }),
      ye.length)
    ) {
          ...
          for (var s = 0.2, r = 0; 2 > r; r++) {
            ...
            if (0 > c) {
              var f,
                p,
                h =
                  (e[r ? "pageX" : "pageY"] - ye.offset()[r ? "left" : "top"]) /
                  l;
              if (i == h) return;
              i = h;
              var m =
              ...
              if (
                ...
                if (h > s && 1 - s > h) return;
                ((f = 0.5 > h ? 0 : c - 1),
                  (p = (Ee * Math.abs(m - f)) / (Math.abs(h - 0.5) - s)));
              } else
              ...
              t.support.transform && t.support.transition
                ...
                : n.animate(
                    r ? { left: f } : { top: f },
                    p,
                    Ee > 0 ? "linear" : "easeOutCubic",
                  );
            } else
              (t.support.transform && t.support.transition) ||
                n.css(r ? "left" : "top", r ? c / 2 : 0);
          }
        }
      }),
        s.mouseout(function () {
      ...
      if (n == e) {
        ...
        if ((i.addClass("ws_selthumb"), !Te)) {
          ...
          if (t.support.transform && t.support.transition) {
            a = d(o);
            var r = -Math.max(
                Math.min(s.left, -a.left),
                s.left + i.width() - ye.width(),
              ),
              l = -Math.max(
                Math.min(s.top, 0),
                s.top + i.height() - ye.height(),
              );
            o.css({
  ...
  function x(t) {
    z("A", we).each(function (e) {
      e == t
        ? z(this).addClass("ws_selbull")
        : z(this).removeClass("ws_selbull");
    });
  }
  function _(t) {
    var e = j[t],
  ...
  function F(t, e, n) {
    for (
      var i =
          "padding-left|padding-right|border-left-width|border-right-width".split(
            "|",
          ),
        a = 0,
        o = 0;
    ...
    return (
      ...
      n &&
        (s +=
          (parseFloat(M(t, "margin-left")) || 0) +
          (parseFloat(M(t, "margin-right")) || 0)),
      s
    );
  }
  function S(t, e, n) {
    for (
      var i =
          "padding-top|padding-bottom|border-top-width|border-bottom-width".split(
            "|",
          ),
        a = 0,
        o = 0;
    ...
    return (
      ...
      n &&
        (s +=
          (parseFloat(M(t, "margin-top")) || 0) +
          (parseFloat(M(t, "margin-bottom")) || 0)),
      s
    );
  }
  function T(t, e, n, i, a) {
    function o(t) {
      ...
      z(s[t])
        ...
        .css({ opacity: 0 })
        .animate({ opacity: n }, a, "easeOutCirc")
        .animate(
          { top: 0, left: 0 },
    ...
    (z(s[0]).css({ left: (e.left1 || 0) + "px", top: (e.top1 || 0) + "px" }),
      z(s[1]).css({ left: (e.left2 || 0) + "px", top: (e.top2 || 0) + "px" }));
    var a = e.duration || a;
    (o(0),
      setTimeout(
        function () {
  ...
  function E(t, e) {
    ...
    (t.wrap(o),
      ...
      "static" == t.css("position")
        ? (o.css({ position: "relative" }), t.css({ position: "relative" }))
        : (z.extend(a, {
    ...
    var c = {};
    ((c[r] = (l ? "+=" : "-=") + u),
      o.animate({ opacity: 1 }, { duration: e.duration, easing: e.easing }),
      t.animate(c, {
        queue: !1,
        duration: e.duration,
        easing: e.easing,
  ...
  function P(t, e, n) {
    var i = 1 * new Date(),
      a = function () {
        ...
        o >= 1
          ? (t(1), cancelAnimationFrame(a), n && n())
  ...
  function O() {
    ...
    if (
      (e > 0 &&
        ...
        q.css("fontSize", Math.max(10 * Math.min(n / t.width || 1, 1), 6)),
      2 > e &&
        (q.css("height", ""),
        i.each(function () {
          z(this).css({
  ...
  (q.wrap("<div></div>"),
    z("<div>")
      ...
      .append(N.find("li:first img:first").clone().css({ width: "100%" }))
      .prependTo(N),
    V.css({
      position: "absolute",
      top: 0,
  ...
  if (
    ...
    (V.css({ width: B + "00%" }),
      j.css({ width: 100 / B + "%" }),
      H.css({ width: 100 / B + "%", left: -100 / B + "%" }),
      Q.css({ width: 100 / B + "%", left: (100 * R) / B + "%" }));
  } else
    (V.css({ width: R + "00%", display: "table" }),
      j.css({ display: "table-cell", float: "none", width: "auto" }),
      H.css({ width: 100 / R + "%", left: -100 / R + "%" }),
      Q.css({ width: 100 / R + "%", left: "100%" }));
  var Y =
    t.onBeforeStep ||
    function (t) {
      return t + 1;
  ...
  (j.each(function () {
    for (
      ...
      this.childNodes[n] != t.get(0) && this.childNodes[n] != t.get(1)
        ? e.append(this.childNodes[n])
        : n++;
    (z(this).data("descr") ||
      (e.text().replace(/\s+/g, "")
        ? z(this).data("descr", e.html().replace(/^\s+|\s+$/g, ""))
        : z(this).data("descr", "")),
      z(this).css({ "font-size": 0 }),
      z(this).data("type", t[0].tagName));
    z(">iframe", this).css("opacity", 0);
    G[G.length] =
      z(">a>img", this).get(0) ||
      z(">iframe+img", this).get(0) ||
      z(">*", this).get(0);
  }),
    (G = z(G)),
  ...
  L.wsHideEffect = l;
  var re,
    le = z('<div class="ws_video_btn"><div></div></div>').appendTo(q),
    ue = new (function () {
      function e(t) {
        ...
        ((re = !1),
          ...
          s[0] && f[t]
            ? (q.removeClass(
              ...
              "youtube" == n(t) &&
              f[t].getPlayerState &&
              1 == f[t].getPlayerState()
                ? f[t].pauseVideo()
                : "vimeo" == n(t) &&
                  f[t].api("paused", function (e) {
                    e || f[t].api("pause");
                  }),
              o && a(1),
              s.css("opacity") > 0
                ? s.animate({ opacity: 0 }, 500, o ? o : 0)
                : o && o())
            : o && o());
      }
      function s(i, o, s) {
        var r = e(i);
        r[0] && (o || r.attr("data-autoplay-video") || t.autoPlayVideo)
          ? ((re = n(i)),
            q.addClass(
              /MSIE/.test($) || /Trident/.test($)
                ? "ws_video_playing_ie"
            ...
            X && X.hide(),
            a(),
            "youtube" == re && f[i] && f[i].playVideo
              ? f[i].playVideo()
              : "vimeo" == re && f[i] && f[i].api("play"),
            r.css("opacity") < 1
              ? r.css("zIndex", 1).animate({ opacity: 1 }, 500, s ? s : 0)
              : s && s())
          : s && s();
      }
      function r(e, n) {
        ((n.attr("data-autoplay-video") || t.autoPlayVideo) &&
          ((re = "youtube"), m()),
          (f[e] = new YT.Player(n[0], {
            events: {
              onStateChange: function (t) {
                1 == t.data || 3 == t.data
                  ? s(e, 1)
                  : (2 != t.data && 0 != t.data) || "youtube" != re || o(e);
              },
              onReady: function () {
                ((n.css.zIndex = 1), s(e));
              },
  ...
  if (de && (de = s(de))) {
      ...
      u(
        ...
        function (e, n) {
          (m(),
            ...
            -fe > n && (n = -fe),
            t.support.transform && t.support.transition
              ? V.css("transform", "translate3d(" + n + "px,0,0)")
              : V.css("left", pe + n));
        },
        function (t) {
          var e =
            /ws_playpause|ws_prev|ws_next|ws_bullets/g.test(
              t.target.className,
            ) || z(t.target).parents(".ws_thumbs, .ws_bullets").get(0);
          return e || re
            ? !1
            : ((he = 1),
              (fe = N.width()),
    ...
    if (
      ((de = de.replace(/^\s+|\s+$/g, "")),
      (ce = de ? z("<div>") : 0),
      z(ce).css({ position: "absolute", padding: "0 0 0 0" }).appendTo(Ce),
      ce && document.all)
    ) {
    ...
    if (
      (z(ce).css({ zIndex: 11, right: "5px", bottom: "2px" }).appendTo(Ce),
      ...
      _e &&
        _e
          ...
          .attr({ href: "http://" + de.toLowerCase() })
          .html(de)
          .bind("contextmenu", function () {
            return !1;
          })
          .show()
          .appendTo(ce || document.body)
          .attr("target", "_blank"),
      t.controls)
    ) {
    ...
    if (ze) {
      if (window.Audio && ze.canPlayType && ze.canPlayType("audio/mp3"))
        ...
        ((window[Ve] = { onInit: function () {} }),
          swfobject.createSWF(
            { data: Le + "player_mp3_js.swf", width: "1", height: "1" },
            {
    ...
    if (t.fullScreen) {
      ...
      if (Re) {
        ...
        (document.addEventListener(Re.fullscreenchange, function () {
          A()
            ? (We.addClass("ws_fs_wrapper"), (je = 1), O())
            : (We.removeClass("ws_fs_wrapper"), (je = 0), O());
        }),
          z("<a href='#' class='ws_fullscreen'></a>")
            .on("click", I)
            .appendTo(q),
          (L.wsToggleFS = I));
      }
    ...
    return (
      (L.wsResponsive = function (e) {
        if (e >= 0 && 3 >= e) {
          ...
          (q
            .removeClass("boxed-mode fullwidth-mode fullscreen-mode")
            .addClass(n),
            (t.responsive = e),
            O());
        }
...
function ws_seven(t, e, i) {
    ...
    return (
      ...
      o &&
        (d(e).each(function (t) {
          var e = t % f,
            n = Math.floor(t / f),
            o = 0.2 * p + (0.15 * p * (35 * a(e, f) + 4 * n)) / (f * g);
          (d(this)
            .css({
              left: s / 2,
              top: h / 2,
            ...
            d(this)
              .find("img")
              .css({ left: 0, top: 0, width: 0, height: 0 })
              .delay(o)
              .animate(
                {
                  left: (-s * e) / f + i.marginLeft,
        ...
        I.delay(0.1 * p).animate({ opacity: 1 }, 0.2 * p, "easeInCirc")),
      setTimeout(r, o ? 0.5 * p : 0.4 * p),
      {
        stop: function () {
          r();
        },
  ...
  function r(t, e, i, a) {
    ...
    if (y) {
      ...
      return (
        o.drawImage(t.get(0), 0, 0, e.width, e.height),
  ...
  this.go = function (a, n) {
    ...
    for (var p = 0; f * g > p; p++) {
      ...
      (d((u[p] = document.createElement("div")))
        .css({
          position: "absolute",
          overflow: "hidden",
          transform: "translate3d(0,0,0)",
        ...
        .append(
          d("<img>")
            .css({ position: "absolute", transform: "translate3d(0,0,0)" })
            .attr("src", e.get(s ? n : a).src),
        ),
        s &&
          d((m[p] = document.createElement("div")))
            .css({
              position: "absolute",
              overflow: "hidden",
              transform: "translate3d(0,0,0)",
    ...
    if (s) {
      ...
      (y && C) ||
        ((y = 0), (C = r(d(e.get(n)), l, 8)), b && (b.remove(), (b = 0)));
    } else
      I.append(
        d("<img>")
          .css({ position: "absolute", top: 0, left: 0 })
          .css(l)
          .attr("src", e.get(n).src),
      );
...
function ws_cube(t, e, i) {
  function s(t, e, i, s) {
    return (
      ...
      (t + e) / 20 +
      "px rgba(" +
      (s > i ? "0,0,0,.6" : i > s ? "255,255,255,0.8" : "0,0,0,.0") +
      ")"
    );
  }
  var n = jQuery,
  ...
  var p = {
      ...
      testDom: function (t) {
        for (var e = this.domPrefixes.length; e--; )
          if (
            "undefined" != typeof document.body.style[this.domPrefixes[e] + t]
          )
            return !0;
        return !1;
      },
      ...
      cssTransforms3d: function () {
        var t =
          "undefined" != typeof document.body.style.perspectiveProperty ||
  ...
  this.go = function (p, l) {
    function m(e, i, o, a, c, p, f, u, l, m) {
      ...
      var v = e.width(),
        w = e.height();
      if (
        (i.front.css({ transform: "rotateY(0deg) rotateX(0deg)" }),
        i.back.css({
          opacity: 1,
        ...
        var b = n("<div>")
            .css(h)
            .css("boxShadow", s(v, w, 0, 0))
            .appendTo(i.front),
          x = n("<div>")
            .css(h)
            .css("boxShadow", s(v, w, p, f))
            .appendTo(i.back);
      g && e.css({ transform: "translateZ(-" + o + "px)" });
      var T = setTimeout(function () {
        var e =
          "all " + t.duration + "ms cubic-bezier(0.645, 0.045, 0.355, 1.000)";
        (i.front.css({
          transition: e,
          ...
          r ||
            (b.css({ transition: e, boxShadow: s(v, w, u, l) }),
            x.css({ transition: e, boxShadow: s(v, w, 0, 0) })),
    ...
    if (
      ...
      var w = i.width(),
        ...
        x = {
          ...
          t.direction ||
            ["left", "right", "down", "up"][Math.floor(4 * Math.random())]
        ],
        T = n("<img>").css(v),
      ...
      var C = !!((p - l + 1) % e.length) ^ t.revers ? "left" : "right",
        ...
        I = n("<div>")
          ...
          .appendTo(c);
      (c.css({ left: "auto", right: "auto", top: 0 }).css(C, 0).show(),
        c.show(),
        a.hide(),
        I.animate(
          { width: "100%", left: 0 },
...
function ws_brick(t, e, a) {
  function r(a) {
    for (
      var r = {}, n = e.get(a), o = t.width / f, i = t.height / h, d = 0;
      f * h > d;
      d++
    ) {
      var a = d % f,
  ...
  function n(t, e, a, r, n) {
    for (var o in e)
      (e[o].topEdge.css({
        ...
        background: a[o],
        transform:
          "rotateX(90deg) translate3d(0,-" + t / 2 + "px," + t / 2 + "px)",
      }),
        e[o].bottomEdge.css({
          width: r,
          height: t,
        ...
        e[o].leftEdge.css({
          ...
          background: a[o],
          transform:
            "rotateY(90deg) translate3d(" + t / 2 + "px,0,-" + t / 2 + "px)",
        }),
        e[o].rightEdge.css({
          width: t,
          height: n,
          ...
          if (!(s + t[h].animate.delay > f)) {
            ...
            if (((i = {}), (o = ""), c > 1)) {
              if (t[h].part[0].ws_delay[1])
                return (cancelAnimationFrame(l), void e());
            } else {
              0.5 >= c
                ? ((a = d.easing.easeInBack(1, 2 * c, 0, 1, 1, 1).toFixed(3)),
                  (r = d.easing.easeInBackQ(1, 2 * c, 0, 1, 1, 1).toFixed(3)),
                  (n = d.easing.easeInBackQ2(1, 2 * c, 0, 1, 1, 1).toFixed(3)),
                  t[h].back.css("backfaceVisibility", "hidden"))
                : ((a = d.easing
                    .easeOutBack(1, 2 * (c - 0.5), 0, 1, 1, 1)
                    .toFixed(3)),
                  (r = d.easing
                    .easeOutBackQ(1, 2 * (c - 0.5), 0, 1, 1, 1)
                    .toFixed(3)),
                  (n = d.easing
                    .easeOutBackQ2(1, 2 * (c - 0.5), 0, 1, 1, 1)
                    .toFixed(3)),
                  t[h].back.css("backfaceVisibility", "visible"));
              for (var p in t[h].animate[0.5 >= c ? "half" : "end"]) {
                var g = t[h].animate[0.5 >= c ? "begin" : "half"][p] || 0,
                  m = t[h].animate[0.5 >= c ? "half" : "end"][p] || 0;
                ("object" != typeof m &&
                  (m =
                    "scale" === p || "rotateX" === p || "rotateY" === p
                      ? g + (m - g) * r
                      : "left" === p || "top" === p
                        ? g + (m - g) * n
                        : g + (m - g) * a),
                    ...
                    : "scale" === p
                      ...
                      : "translate3d" === p
                        ? (o +=
                            p +
                            "(" +
                            (g[0] + (m[0] - g[0]) * a).toFixed(3) +
                            "px," +
                            (g[1] + (m[1] - g[1]) * a).toFixed(3) +
                            "px," +
                            (g[2] + (m[2] - g[2]) * a).toFixed(3) +
                            "px) ")
                        : (i[p] = m));
              }
              (t[h].wrapper.css({
                transform:
                  "translate3d(" +
                  (i.left ? i.left : 0).toFixed(3) +
                  "px," +
                  (i.top ? i.top : 0).toFixed(3) +
                  "px,0)",
              }),
                delete i.left,
                delete i.top,
  ...
  function i(e, r, i, s) {
    var d = a.width(),
      ...
      c = d / f,
      p = l / h,
      g = 0.4 * t.duration > 1e3 ? 1e3 : 0.4 * t.duration,
      m = 0.6 * t.duration,
      u = [0, 0];
    (n(w, e, v[r], c, p),
      x.css({
  ...
  function s(t, e) {
    ...
    for (
      var d = (e.w ? e.w : t.width * e.h ? e.h : t.height) || a.length,
        l = {},
        f = "",
        h = [],
        c = { dominant: { name: "", count: 0 } },
        p = 0;
      d > p;
    ) {
      if (
  ...
  var d = jQuery,
    ...
    x = d("<div>")
      .addClass("ws_effect")
      .css("overflow", t.responsive > 1 ? "hidden" : "visible"),
  ...
  this.go = function (n, o) {
    ...
    for (var g = 0; f * h > g; g++) {
      ...
      u[g] = {
        ...
        wrapper: I,
        leftEdge: b
          ? d("<div>").addClass("ws_left_edge").css(A).appendTo(_)
          : 0,
        rightEdge: b
          ? d("<div>").addClass("ws_right_edge").css(A).appendTo(_)
          : 0,
        topEdge: b ? d("<div>").addClass("ws_top_edge").css(A).appendTo(_) : 0,
        bottomEdge: b
          ? d("<div>").addClass("ws_bottom_edge").css(A).appendTo(_)
          : 0,
      };
    }
    x.show();
    ...
    if (
      ...
      for (var Z in u) {
        ...
        var j = t.duration * (1 - Math.abs((p * c - Y * X) / (2 * h * f))),
          q = s(-1, 1) > 0 ? 1 : -1,
          M = s(-1, 1) > 0 ? 1 : -1;
        (u[Z].wrapper.css({ width: E, height: Q }),
          u[Z].part
            .css({
              position: "absolute",
              top: q * Q,
            ...
            .animate({ top: 0, left: 0, opacity: 1 }, j, function () {
              (O++,
                O == h * f &&
                  (m.stop(1, 1), (F = !1), l.trigger("effectEnd"), x.empty()));
            }));
      }
    }
  };
...
jQuery.extend(jQuery.easing, {
  ...
  easeOutBackQ2: function (t, e, a, r, n) {
    var o = (e /= n) * e;
    return (
      a + r * (1.5 * o * e * o - 5 * o * o + 10 * o * e - 12 * o + 6.5 * e)
    );
  },
});
function ws_blinds(t, i, e) {
  function n(i, e, n, o, s) {
    t.support.transform && t.support.transition
      ? (e.transform || (e.transform = ""),
        e.left &&
          (e.transform += " translate3d(" + (e.left ? e.left : 0) + "px,0,0)"),
        delete e.left,
  ...
  this.go = function (l, h, p) {
    ...
    var w = o(i[h]),
      c = { width: w.width() || t.width, height: w.height() || t.height },
      v = w.clone().css(c).appendTo(a);
    (n(v, { left: 0 }),
      n(
        v,
        { left: (g ? -1 : 1) * v.width() * 0.5 },
        t.duration,
        0.1 * t.duration,
      ));
    for (var m = 0; m < f.length; m++) {
      var T = f[m],
        b = o(i[l])
          ...
          .css(c)
          .appendTo(T);
      (n(b, { left: g ? b.width() - T.position().left : -b.width() }),
        n(
          b,
          { left: -T.position().left },
          (t.duration / (f.length + 1)) * (g ? f.length - m + 1 : m + 2),
          0,
          (!g && m == f.length - 1) || (g && !m)
            ? function () {
                (s.trigger("effectEnd"),
...
(function ($) {
  ...
  function resizeWnd() {
    ...
    if (curResponsive > 1) sliderCont.css("width", "100%");
  ...
  $("#devices").on("click", "a", function (e) {
    ...
    if (/laptop|tablet|mobile/g.test(thisClass)) {
      ...
      if (curResponsive > 1) {
        ...
        curResponsive = 1;
        $("#devices")
          .find(".boxed, .fullwidth, .fullscreen")
          .removeClass("checked");
      ...
      if (/boxed/g.test(thisClass)) {
        ...
        sliderCont.css("maxWidth", "none");
        if (wowSlider[0].wsToggleFS) wowSlider[0].wsToggleFS();
        return;
      }
      $("#devices")
        .find(".boxed, .fullwidth, .fullscreen")
  ...
  diagram: function () {
    ...
    $(".get")
      ...
      .each(function (i) {
        ...
        z.node.setAttribute("pointer-events", "none");
        z.node.style.pointerEvents = "none";
        z_bg
          .mouseover(function () {
            z.animate({ "stroke-width": 50, opacity: 0.75 }, 1000, "elastic");
            if (Raphael.type != "VML") {
              z.toFront();
              title.toFront();
            }
...
!(function () {
  ...
  e.prototype = {
    ...
    _enableMobileAudio: function () {
      var e = this || n,
        o = /iPhone|iPad|iPod|Android|BlackBerry|BB10|Silk|Mobi/i.test(
  ...
  o.prototype = {
      ...
      if (t._webAudio) {
        var c = function () {
            ...
            (l.gain.setValueAtTime(e, n.ctx.currentTime),
              ...
              void 0 === l.bufferSource.start
                ? i._loop
                  ? l.bufferSource.noteGrainOn(0, d, 86400)
                  : l.bufferSource.noteGrainOn(0, d, _)
                : i._loop
                  ? l.bufferSource.start(0, d, 86400)
                  : l.bufferSource.start(0, d, _),
              s !== 1 / 0 &&
                (t._endTimers[i._id] = setTimeout(t._ended.bind(t, i), s)),
              o ||
                setTimeout(function () {
                  t._emit("play", i._id);
                }, 0));
        ...
        var v = function () {
          ...
          m =
            ...
            ((window && window.ejecta) ||
              (!l.readyState && n._navigator.isCocoonJS));
      ...
      for (var s = a._getSoundIds(r), l = 0; l < s.length; l++) {
        ...
        if (c) {
          ...
          c._interval = setInterval(
            function (n, t) {
              (d > 0 && (v += "in" === i ? 0.01 : -0.01),
                (v = Math.max(0, v)),
                (v = Math.min(1, v)),
                (v = Math.round(100 * v) / 100),
                a._webAudio
                  ? (void 0 === r && (a._volume = v), (t._volume = v))
                  : a.volume(v, n, !0),
                ((o < e && v <= o) || (o > e && v >= o)) &&
        ...
        if ((i = t._soundById(o[d]))) {
          ((i._rateSeek = t.seek(o[d])),
            ...
            t._webAudio && i._node && i._node.bufferSource
              ? (i._node.bufferSource.playbackRate.value = e)
    ...
    _clearTimer: function (e) {
      ...
      return (
        n._endTimers[e] &&
          (clearTimeout(n._endTimers[e]), delete n._endTimers[e]),
        n
      );
    },
...
!(function () {
  ...
  ((HowlerGlobal.prototype._pos = [0, 0, 0]),
    ...
    (HowlerGlobal.prototype.pos = function (n, e, o) {
      var t = this;
      return t.ctx && t.ctx.listener
        ? ((e = "number" != typeof e ? t._pos[1] : e),
    ...
    (Howl.prototype.init = (function (n) {
      return function (e) {
        var o = this;
        return (
          (o._orientation = e.orientation || [1, 0, 0]),
          ...
          (o._onstereo = e.onstereo ? [{ fn: e.onstereo }] : []),
          (o._onpos = e.onpos ? [{ fn: e.onpos }] : []),
          (o._onorientation = e.onorientation ? [{ fn: e.onorientation }] : []),
          n.call(this, e)
        );
      };
    })(Howl.prototype.init)),
        ...
        if (p) {
          ...
          ((p._stereo = e),
            ...
            p._node &&
              ...
              "spatial" === r
                ? p._panner.setPosition(e, 0, 0)
                : (p._panner.pan.value = e)),
    ...
    (Howl.prototype.pos = function (e, o, t, r) {
      ...
      for (var a = i._getSoundIds(r), p = 0; p < a.length; p++) {
        ...
        if (s) {
          ...
          ((s._pos = [e, o, t]),
            s._node &&
              ((s._panner && !s._panner.pan) || n(s, "spatial"),
    ...
    (Howl.prototype.orientation = function (e, o, t, r) {
      ...
      if (
        ((o = "number" != typeof o ? i._orientation[1] : o),
      ...
      for (var a = i._getSoundIds(r), p = 0; p < a.length; p++) {
        ...
        if (s) {
          ...
          ((s._orientation = [e, o, t]),
            s._node &&
              (s._panner ||
                (s._pos || (s._pos = i._pos || [0, 0, -0.5]), n(s, "spatial")),
    ...
    (Howl.prototype.pannerAttr = function () {
      ...
      if (1 === i.length) {
        if ("object" != typeof i[0])
          return (
            (t = r._soundById(parseInt(i[0], 10))),
            ...
            (r._pannerAttr = {
              ...
              coneOuterAngle:
                void 0 !== e.coneOuterAngle
                  ...
                  : r._coneOuterAngle,
              coneOuterGain:
                void 0 !== e.coneOuterGain ? e.coneOuterGain : r._coneOuterGain,
              distanceModel:
                void 0 !== e.distanceModel ? e.distanceModel : r._distanceModel,
              maxDistance:
                void 0 !== e.maxDistance ? e.maxDistance : r._maxDistance,
              panningModel:
                void 0 !== e.panningModel ? e.panningModel : r._panningModel,
              refDistance:
                void 0 !== e.refDistance ? e.refDistance : r._refDistance,
              rolloffFactor:
                void 0 !== e.rolloffFactor ? e.rolloffFactor : r._rolloffFactor,
            }));
      ...
      for (var a = r._getSoundIds(o), p = 0; p < a.length; p++)
        if ((t = r._soundById(a[p]))) {
          ...
          s = {
            coneInnerAngle:
              void 0 !== e.coneInnerAngle ? e.coneInnerAngle : s.coneInnerAngle,
            coneOuterAngle:
              void 0 !== e.coneOuterAngle ? e.coneOuterAngle : s.coneOuterAngle,
            coneOuterGain:
          ...
          var l = t._panner;
          l
            ? ((l.coneInnerAngle = s.coneInnerAngle),
            ...
            : (t._pos || (t._pos = r._pos || [0, 0, -0.5]), n(t, "spatial"));
        }
      return r;
    }),
    (Sound.prototype.init = (function (n) {
      return function () {
        ...
        ((e._orientation = o._orientation),
          ...
          e._stereo
            ? o.stereo(e._stereo)
            : e._pos && o.pos(e._pos[0], e._pos[1], e._pos[2], e._id));
      };
...
$(function () {
  (function () {
    ...
    $(".W-introduce-me").on("click", function () {
      window.open("http://ipa.test.huiguoguo.com:8888/Home/Other?id=1");
    });
    $(".W-time").hover(
      function () {
        $(this).css({
    ...
    // Dynamically calculate years of experience from April 2019
    (function () {
      var startYear = 2019;
      var startMonth = 4;
    ...
    var mySwiper1 = new Swiper(".swiper-container1", {
      ...
      onSlideChangeStart: function (swiper) {
        if (swiper.activeIndex == 0) {
          ...
          $(".skills-text").addClass("fadeInLeft");
          $(".navigation li a").removeClass("a-active");
    ...
    if ($(".swiper-container2").length > 0) {
      mySwiper2 = new Swiper(".swiper-container2", {
        ...
        onSlideChangeStart: function (swiper) {
          ...
          $('input[name="project-page"]').eq(index).prop("checked", true);
        },
      });
      $(document).on("change", 'input[name="project-page"]', function () {
        var index = $('input[name="project-page"]').index(this);
        if (mySwiper2) {
    ...
    if (!!window.ActiveXObject || "ActiveXObject" in window) {
      ...
      $(".W-introduce-me").css({
        background:
          'url("https://carelife.top/web-static/asjl/wx-profile-picture.jpg") no-repeat',
    ...
    $(".bg-3").on("click touchstart", function () {
      ...
      $(
        ".swiper-container,.W-head-portrait,.nav-yuan,.bg-3,.W-page2,.W-s-yyue",
      ).addClass("swiper-slide-blur");
    });
    $(".bg-2").on("click", function () {
      clearTimeout(ping);
      $(
        ".swiper-container,.W-head-portrait,.nav-yuan,.bg-3,.W-page2,.W-s-yyue",
      ).removeClass("swiper-slide-blur");
    ...
    var Imgatr = [
      "https://carelife.top/web-static/asjl/sj_head_bg.jpg",
      "https://carelife.top/web-static/asjl/sj_head_bg2.jpg",
      "https://carelife.top/web-static/asjl/sj_head_bg3.jpg",
    ];
    ...
    $(".Ws-tou")
      ...
      .attr(
        "src",
        "https://carelife.top/web-static/asjl/wx-profile-picture.jpg",
      );
    var Wjn = [
      {
        color: "#1abc9c",
    ...
    $(".Ws-tu")
      ...
      .each(function (index) {
        ...
        $(this)
          .find(".Ws-ph .Ws-ph-f")
          .css("width", $(this).find(".Ws-ph .Ws-ph-f").data("percentage"));
      });
    $(window).resize(function () {
      $("#wowslider-container .ws_images").css("height", $(window).height());
      if ($(window).width() <= 770) {
